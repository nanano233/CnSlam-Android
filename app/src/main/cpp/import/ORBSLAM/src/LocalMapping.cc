...
{
//////////////CommSLAM////////////////////////////
LocalMapping::LocalMapping(System* pSys, Atlas *pAtlas, KeyFrameDatabase* pKFDB, ORBVocabulary* pVoc, Uncertainty *pUncertainty, const float bMonocular, bool bInertial, string RunType, const string &_strSeqName, string serverIp, string serverPort):
